...
inline uint8 const reverselookup[] = // found on the internet, hopefully correct
{
...
class HVP
{
    ...
    PIO pio;
    uint sm;
    uint8 sdi, sii, sdo, sci;
    uint offset = 0;
    uint8 reverse8(uint8 in)
    {
        return reverselookup[in];
    }
    ...
    uint16 TX_NOOP()
    {
        return TX_RX(0b00000000, 0b01001100);
    }
